...
const Clients = () => {
  return (
    <div className="w-full my-20 px-[16px] ">
      <div className="head-text text-left">Hear From My Clients</div>
      <div className="grid w-full lg:grid-cols-2 grid-cols-1 gap-5 mt-8 ">
        {clientReviews.map(({ id, name, img, position, review }) => {
          return (
            <div className="col-span-1 bg-[#111111]  p-8 py-12 flex flex-col  justify-center rounded-2xl">
              ...
              <div className="flex justify-between w-full flex-wrap gap-5">
                <div className="flex gap-2 mt-5">
                  ...
                  <div className="flex flex-col gap-1.5 justify-start">
                    ...
                    <div className="text-[15px] font-normal text-gray-500">
                      {position}
                    </div>
                  </div>
